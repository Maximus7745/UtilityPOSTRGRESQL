...
Console.WriteLine("Для загрузки файлов в базу данных введите load " +
    ", тип загружаемых файлов через пробел нужный символ (j - должность, d - подразделение, e - сотрудник) " +
    "и полный путь к файлу также через пробел." +
    "Для вывода текущей структуры данных введите output, при необходимости, через пробел можно указать " +
